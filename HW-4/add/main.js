...
const array1 = [2, 17, 13, 6, 22, 31, 45, 66, 100, -18];
let item = 0;
...
for (let arrTypeElement of arrType) {
    if (typeof arrTypeElement === 'string')
        console.log(arrTypeElement);
}
// #0pm3EyTKy9
...
arrAdd[arrAdd.length] = 88;
arrAdd[arrAdd.length] = false;
...
const books = [
    {
        ...
        title: "Собор", pages: 450, authors: ["Олесь Гончар"], genres: ["Соціальна проза", "Драма"]
    }
];
