...
const filteredUsers1 = users1.filter(user => user.id % 2 === 0);
console.log(filteredUsers1);
// Взяти масив з  User[] з попереднього завдання, та відсортувати його по id. по зростанню (sort)
const sortedUsers = users1.toSorted((a, b) => a.id - b.id);
...
class Car {
    ...
    engine;
    driver;
    constructor(model, manufacturer, release, speed, engine, driver) {
        this.model = model;
